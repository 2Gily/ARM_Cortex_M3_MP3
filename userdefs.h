...
#define LED_OUT0			PD_OUTPUT(8)
#define LED_OUT1			PD_OUTPUT(9)
#define LED_OUT2			PD_OUTPUT(10)
#define LED_OUT3			PD_OUTPUT(11)
...
extern void touch_adjust (unsigned sw);
...
// i2c_app.c
extern void init_i2c_seep (void);
